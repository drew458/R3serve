...
def automaticMode(inputUsername, inputPassword, inputCourse, isHeadless, isHeroku, isLogging):
    """
...
def manualMode(inputUsername, inputPassword, inputCourse, biblioDay, biblioHour, isHeadless, isLogging, isHeroku):
    """
